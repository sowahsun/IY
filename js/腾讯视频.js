var rule = {
	...
	lazy: `js:
   const blockedLinks = [
    'https://mp.xn--v4q818bf34b.com/d/ty/924031152482930614/Ad.mp4'
    // 可以在这里添加更多要屏蔽的链接
];
...
if (/\.m3u8$/.test(input)) {
    ...
    let kurl = 'http://101.201.171.207:9898/home/api?type=ys&uid=17303&key=blmorxyzBCDHKLM579&url=' + encodeURIComponent(input);
...
`,
	...
	二级: $js.toString(() => {
		...
		VOD.vod_play_from = yg.length < 1 ? "腾云" : "腾云$$$腾云 预告及花絮";
